...
export function DataTable<TData, TValue>({ data, columns, searchTag, currentPage, totalPages }: DataTableProps<TData, TValue>) {
                                    ...
                                    {row.getVisibleCells().map((cell) => (
                                        cell.column.columnDef.header === "City" ? (
                                            ...
                                            <div key={cell.id} className="grid grid-cols-2 gap-2">
                                                <p className="mb-2 text-sm font-semibold text-gray-800 dark:text-white">{cell.column.columnDef.header}</p>
