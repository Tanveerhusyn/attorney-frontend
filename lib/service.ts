...
export async function getCities(page: string): Promise<City[] | ErrorResponse> {
  try {
...
export async function getAttorneysByCityId(
  cityId: string
): Promise<Attorney[] | ErrorResponse> {
  try {
...
export async function getArticlesByCityId(
  cityId: string
): Promise<Article[] | ErrorResponse> {
  try {
...
// getReviewsByCityId
export async function getReviewsByCityId(
  cityId: string
