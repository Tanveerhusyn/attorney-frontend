...
const Cities = async ({ searchParams }: { searchParams: string }) => {

  const page = searchParams?.page || "1";

  const cities = await getCities(page)

  const re = cities?.results;
    ...
    <div className="w-full flex justify-center items-center m-4">
      <div className="w-full min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="container relative flex flex-col min-h-screen px-6 py-8 mx-auto">
          ...
          <DataTable data={re} columns={columns} searchTag="city" currentPage={page} totalPages={totalP} />
